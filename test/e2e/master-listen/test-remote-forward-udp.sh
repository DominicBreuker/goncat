...
# Start goncat master with UDP remote port forwarding AND exec mode
...
spawn /opt/dist/goncat.elf master listen $transport://:8080 -R U:7001:master-companion:9001 --exec sh

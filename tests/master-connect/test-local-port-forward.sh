...
# Test that goncat accepts the local port forwarding flag and connects successfully
...
send -- "echo 'Local port forwarding test: connection established with -L flag'\n"
Utils::wait_for "Local port forwarding test: connection established with -L flag"
